...
def classify_city(city):
    ...
    city_map = {
        "حولي": {"البدع", "الجابرية", "الخالدية", "الدسمة", "الدعية", "الروضة", "الروميثية", 
        ...
        "الجهراء": {"أمغرة", "اسطبلات الجهراء", "الجهراء", "الدوحة", "الدوحة / القيروان", 
                    ...
                    "مدينة سعد العبدالله", "مزارع الصليبية", "معسكرات الجهراء"},
        ...
        "الفروانية": {"اشبيلية", "الأندلس", "الافينيوز", "الحساوي", "الرابية", "الرحاب", 
                      ...
                      "شارع محمد بن القاسم", "صباح الناصر", "صبحان", "عبدالله مبارك الصباح", 
                      "غرب عبدالله المبارك", "منطقة المطار", "ميناء الشويخ"},
        
        "منطقه الفصباحيه": {"الرقة", "الصباحية", "الظهر", "العقيلة", "المقوع", "جابر العلي", 
                             "فهد الأحمد", "هدية"},
        
        "منطقه الفحاحيل": {"أبو حليفة", "الفحيحيل", "الفحيحيل الصناعية", "المنقف"},
        
        "منطقه المهبوله": {"الفنطاس", "المهبوله"},
        
        "منطقه صباح الأحمد": {"الادعمى", "الزور", "الشعيبة", "النويصيب", "الوفرة", 
                              "ام الهيمان  / على صباح السالم", "خيران", "شاليهات بنيدر", 
                              "صباح الأحمد الاولي", "صباح الأحمد الثالثة", "صباح الأحمد الثانية", 
                              "صباح الأحمد الحكومية", "صباح الأحمد الخامسة", "صباح الأحمد الرابعة", 
                              "ميناء عبد الله"},
        
        "منطقه صباح السالم": {"أبو الحصانية", "أبو فطيرة", "اسواق القرين", "الاحمدي", 
